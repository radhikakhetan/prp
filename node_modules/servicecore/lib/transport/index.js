...
exports = module.exports = function transportFactory(config) {
    ...
    wrapped = function (options, callback) {
        var connectTimeout, socketTimeout,
            adaptiveConnectTimeout, adaptiveSocketTimeout;
        ...
        adaptiveConnectTimeout = Math.min(
                timeoutengine.getConnectTimeout(config.clientName) || config.connectTimeout,
                config.connectTimeout);
        adaptiveSocketTimeout = Math.min(
                timeoutengine.getSocketTimeout(config.clientName) || config.socketTimeout,
                config.socketTimeout);

        if (config.useAdaptiveTimeout) {
            connectTimeout = adaptiveConnectTimeout;
            socketTimeout = adaptiveSocketTimeout;
        }
        else {
        ...
        objutil.deepMerge({
            ...
            adaptiveConnectTimeout: adaptiveConnectTimeout,
            adaptiveSocketTimeout: adaptiveSocketTimeout,
