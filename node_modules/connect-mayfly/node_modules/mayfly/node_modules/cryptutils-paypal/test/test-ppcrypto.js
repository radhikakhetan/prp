...
describe('PPCrypto', function () {
    ...
    it('should hmac using 3des algorithm', function () {
        var macKey = new Buffer('wZaRd6ATe7MToYltfFwCKV9tx+8=', 'base64')

        var hmac = ppcryptutils.hmacString(configuration.macAlgorithm, macKey, 'sso', '3des');

        assert.strictEqual(hmac, '8WwmtLysPTBzP_vpxsn1EfykddK');
    });
